...
<html>
 ...
 <body class="login" onLoad="javascript:document.forms[0].submit();">
            ...
            <fieldset>
                <div class="row clearfix">
                    ...
                    <div class="connectlabel span1">
                        <input id="dbURL" tabindex="1" maxlength="100" type="text" class="required" name="dbURL" value="localhost">
                    </div>
                </div>
                ...
                <div class="row clearfix ">
                    ...
                    <div class="span1">
                        <input id="dbPort" tabindex="2" maxlength="5" type="text" class="required" name="dbPort" value="5432">
                    </div>
                </div>
                ...
                <div class="row clearfix ">
                    ...
                    <div class="span1">
                        <input id="dbName" tabindex="3" maxlength="64" type="text" class="required" name="dbName" value="everteam">
                    </div>
                </div>
                ...
                <div class="row clearfix ">
                    ...
                    <div class="span1">
                        <input id="username" tabindex="4" maxlength="30" type="text" class="required" name="username" value="everteam">
                    </div>
                </div>
                ...
                <div class="row clearfix ">
                    ...
                    <div class="span1">
                        <input tabindex="5" maxlength="30" type="password" name="password" id="password" class="required" value="everteam">
                    </div>
                </div>
              </fieldset>
